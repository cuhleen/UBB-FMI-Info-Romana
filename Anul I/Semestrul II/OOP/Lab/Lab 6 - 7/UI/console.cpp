...
constexpr int Optiune_Default_Film = 8;
...
void UI::ui_afiseazaFilme(const VectorDinamic<Film>& filme) {
	if (filme.size() == 0) {
...
void UI::ui_sortare() {
	...
	VectorDinamic<Film> filme = service.sorteaza(reperSortare, ordineSortare);
	ui_afiseazaFilme(filme);
}

void UI::ui_default()
{
	service.adaugaFilm("No Country For Old Men", "Crime", 2007, "Javier Bardem");
	service.adaugaFilm("Taxi Driver", "Drama", 1976, "Robert De Niro");
	service.adaugaFilm("Silence", "Drama", 2016, "Andrew Garfield");
	service.adaugaFilm("A Silent Voice", "Anime", 2016, "Saori Hayami");
	service.adaugaFilm("Barbie", "Comedy", 2023, "Margot Robbie");
	service.adaugaFilm("Puss in Boots 2", "Comedy", 2022, "Antonio Banderas");
	service.adaugaFilm("Baby Driver", "Action", 2017, "Ansel Elgort");
	service.adaugaFilm("Interstellar", "SF", 2014, "Matthew McConaughey");
	cout<<"S-au adaugat filmele default\n";
