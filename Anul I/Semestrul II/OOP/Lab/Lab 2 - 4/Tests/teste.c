...
void testValideazaCheltuiala() {
	Cheltuiala cheltuialaValida = creeazaCheltuiala(-1, 10, 100, "mancare");
	assert(valideazaCheltuiala(cheltuialaValida) == 1);
	distrugeCheltuiala(&cheltuialaValida);

	Cheltuiala cheltuialaIdInvalid = creeazaCheltuiala(1, -10, 100, "mancare");
	assert(valideazaCheltuiala(cheltuialaIdInvalid) == 2);
	distrugeCheltuiala(&cheltuialaIdInvalid);

	Cheltuiala cheltuialaZiInvalida = creeazaCheltuiala(1, 32, 100, "mancare");
...
void testDistrugeLista() {
	...
	adaugaElementInLista(&listaDistruge, creeazaCheltuiala(1, 13, 15, "mancare"));
...
void testSetElement() {
	...
	Cheltuiala cheltuialaNouaSetElement = creeazaCheltuiala(3, 30, 20, "interet");
	...
	assert(strcmp(cheltuialaSetElement.tip, "interet") == 0);
...
void testAdaugaModificaStergeLista() {
	...
	adaugaElementInLista(&listaAdaugare, creeazaCheltuiala(1, 13, 15, "mancare"));
	adaugaElementInLista(&listaAdaugare, creeazaCheltuiala(2, 15, 15, "transport"));
	adaugaElementInLista(&listaAdaugare, creeazaCheltuiala(3, 13, 15, "mancare"));
	adaugaElementInLista(&listaAdaugare, creeazaCheltuiala(4, 15, 15, "transport"));
	adaugaElementInLista(&listaAdaugare, creeazaCheltuiala(5, 13, 15, "mancare"));
	adaugaElementInLista(&listaAdaugare, creeazaCheltuiala(6, 15, 15, "transport"));
	Cheltuiala cheltuialaAdaugare = creeazaCheltuiala(6, 10, 100, "mancare");
	int existaModifica = modificaElementDinLista(&listaAdaugare, cheltuialaAdaugare);
	assert(existaModifica == 0);
	Cheltuiala cheltuialaAdaugare2 = creeazaCheltuiala(7, 10, 100, "mancare");
...
void testCopiazaLista() {
	...
	Cheltuiala cheltuiala1 = creeazaCheltuiala(1, 10, 125, "mancare");
...
void testAdaugaCheltuialaInBuget() {
	...
	assert(adaugaCheltuialaInBuget(&bugetAdaugare, 1, 1, 100, "mancare") == 0);
	assert(bugetAdaugare.Cheltuieli.dimensiune == 1);
	adaugaCheltuialaInBuget(&bugetAdaugare, 1, 1, 100, "mancare");
	assert(bugetAdaugare.Cheltuieli.dimensiune == 1);
	assert(bugetAdaugare.Cheltuieli.elemente[0].id == 1);
	assert(bugetAdaugare.Cheltuieli.elemente[0].zi == 1);
	assert(bugetAdaugare.Cheltuieli.elemente[0].suma == 100);
...
void testModificaCheltuialaDinBuget() {
	...
	adaugaCheltuialaInBuget(&bugetModificare, 1, 1, 100, "mancare");
	assert(modificaCheltuialaDinBuget(&bugetModificare, 1, 2, 200, "transport") == 0);
	...
	assert(bugetModificare.Cheltuieli.elemente[0].suma == 200);
	assert(strcmp(bugetModificare.Cheltuieli.elemente[0].tip, "transport") == 0);
	assert(modificaCheltuialaDinBuget(&bugetModificare, 2, 3, 300, "chirii") == 1);
	assert(modificaCheltuialaDinBuget(&bugetModificare, 1, 2, 200, "transports") == 4);
	distrugeBugetFamilie(&bugetModificare);
}

void testStergeCheltuialaDinBuget() {
	BugetFamilie bugetStergere = creeazaBugetFamilie();
	adaugaCheltuialaInBuget(&bugetStergere, 1, 10, 100, "alimente");
	adaugaCheltuialaInBuget(&bugetStergere, 2, 20, 200, "transport");
...
void testSorteazaDupaId() {
	...
	adaugaCheltuialaInBuget(&bugetSortare, 3, 1, 100, "mancare");
	adaugaCheltuialaInBuget(&bugetSortare, 4, 10, 15, "transport");
	adaugaCheltuialaInBuget(&bugetSortare, 1, 13, 15, "imbracaminte");
	adaugaCheltuialaInBuget(&bugetSortare, 2, 15, 15, "internet");
	adaugaCheltuialaInBuget(&bugetSortare, 6, 13, 15, "mancare");
	...
	assert(cheltuieliDupaId.elemente[0].id == 1);
	assert(cheltuieliDupaId.elemente[1].id == 2);
	assert(cheltuieliDupaId.elemente[2].id == 3);
	assert(cheltuieliDupaId.elemente[3].id == 4);
	assert(cheltuieliDupaId.elemente[4].id == 5);
	assert(cheltuieliDupaId.elemente[5].id == 6);

	distrugeLista(&cheltuieliDupaId);

	cheltuieliDupaId = sorteazaDupaId(&bugetSortare, 1);

	assert(cheltuieliDupaId.elemente[5].id == 1);
	assert(cheltuieliDupaId.elemente[4].id == 2);
	assert(cheltuieliDupaId.elemente[3].id == 3);
	assert(cheltuieliDupaId.elemente[2].id == 4);
	assert(cheltuieliDupaId.elemente[1].id == 5);
	assert(cheltuieliDupaId.elemente[0].id == 6);
...
void testSorteazaDupaSuma() {
	...
	assert(cheltuieliDupaSuma.elemente[0].suma == 15);
	assert(cheltuieliDupaSuma.elemente[1].suma == 15);
	assert(cheltuieliDupaSuma.elemente[2].suma == 15);
	assert(cheltuieliDupaSuma.elemente[3].suma == 15);
	assert(cheltuieliDupaSuma.elemente[4].suma == 15);
	assert(cheltuieliDupaSuma.elemente[5].suma == 100);

	distrugeLista(&cheltuieliDupaSuma);
	cheltuieliDupaSuma = sorteazaDupaSuma(&bugetSortare, 1);

	assert(cheltuieliDupaSuma.elemente[0].suma == 100);
	assert(cheltuieliDupaSuma.elemente[1].suma == 15);
	assert(cheltuieliDupaSuma.elemente[2].suma == 15);
	assert(cheltuieliDupaSuma.elemente[3].suma == 15);
	assert(cheltuieliDupaSuma.elemente[4].suma == 15);
	assert(cheltuieliDupaSuma.elemente[5].suma == 15);
...
void testSorteazaDupaTip() {
	...
	assert(strcmp(cheltuieliDupaTip.elemente[1].tip, "internet") == 0);
	...
	assert(strcmp(cheltuieliDupaTip.elemente[4].tip, "internet") == 0);
	assert(strcmp(cheltuieliDupaTip.elemente[3].tip, "mancare") == 0);
	assert(strcmp(cheltuieliDupaTip.elemente[2].tip, "mancare") == 0);
