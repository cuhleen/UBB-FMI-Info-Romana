...
public class RaceEventService {
    ...
    public RaceEventService(RepoEventDB repoEvent, RepoDuckDB repoDuck) {
    ...
    public RaceEvent createRaceEvent(String title, String desc, long creatorId, List<Double> balize) {
        ...
        // creatorul trebuie recuperat din AppService
        // dar aici presupunem că RepoRaceEventDB știe creatorId doar ca long
        User creator = null; // se setează ulterior în AppService

        RaceEvent event = new RaceEvent(id, title, desc, creatorId, balize);
