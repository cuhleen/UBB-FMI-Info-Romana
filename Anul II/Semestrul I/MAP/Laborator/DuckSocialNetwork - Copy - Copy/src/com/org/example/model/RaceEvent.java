...
public class RaceEvent extends Event {
    ...
    public RaceEvent(long id, String title, String description, long creatorId, List<Double> balize) {
    ...
    public RaceEvent(long id, String title, String description, long creator) {
